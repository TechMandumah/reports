    ...
    <div className="space-y-8">
      ...
      <div className="text-center py-8">
        ...
        <p className="text-gray-600 mb-6 text-lg">
          {language === 'ar' 
            ? 'تصدير جميع بيانات المؤتمرات (الأرقام من 6000 إلى 8999)'
            : 'Export all conferences data (Numbers 6000 to 8999)'
          }
        </p>
        <p className="text-sm text-gray-500 bg-blue-50 rounded-lg p-3 border border-blue-200 max-w-2xl mx-auto">
          {language === 'ar' 
            ? 'يتضمن التقرير جميع البيانات من جدول للمؤتمرات ذات الأرقام من 6000 إلى 8999.'
            : 'The report includes all data from tables for conferences with numbers 6000 to 8999.'
          }
        </p>
      </div>
